...
const { getAccountIds } = require('../utils/getAccountIds.util'); // NOSONAR
const { createNotification } = require('../utils/notification.util');
const accountController = require('./account.controller'); // FIX: Import at the top
...
module.exports = {
    ...
    getPaymentMethods,
    mapPaymentMethodAccount, // FIX: Add comma
    updateCompanyInfo, // Menggunakan fungsi lokal
    getAccounts: accountController.getAccounts, // FIX: Use the imported controller
